...
// from robot center to a coordinate system of the right back leg of a
// quadruped. Assumes legs are positioned in the corner of a rectangular plane
// defined by a length and height.
Eigen::Matrix4f htLegRightBack(float body_length, float body_width);

// Returns the homogeneous transformation matrix representing the transformation
// from robot center to a coordinate system of the right front leg of a
// quadruped. Assumes legs are positioned in the corner of a rectangular plane
// defined by a length and height.
Eigen::Matrix4f htLegRightFront(float body_length, float body_width);

// Returns the homogeneous transformation matrix representing the transformation
// from robot center to a coordinate system of the left front leg of a
// quadruped. Assumes legs are positioned in the corner of a rectangular plane
// defined by a length and height.
