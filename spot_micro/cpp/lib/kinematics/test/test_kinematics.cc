...
TEST(testSetJointAngles, basic_test) {
  ...
  // Test equality
  EXPECT_EQ(four_legs_desired_angs.right_back.ang1,
            test_legs_joint_angs.right_back.ang1);
  EXPECT_EQ(four_legs_desired_angs.right_back.ang2,
            test_legs_joint_angs.right_back.ang2);
  EXPECT_EQ(four_legs_desired_angs.right_back.ang3,
            test_legs_joint_angs.right_back.ang3);

  EXPECT_EQ(four_legs_desired_angs.right_front.ang1,
            test_legs_joint_angs.right_front.ang1);
  EXPECT_EQ(four_legs_desired_angs.right_front.ang2,
            test_legs_joint_angs.right_front.ang2);
  EXPECT_EQ(four_legs_desired_angs.right_front.ang3,
            test_legs_joint_angs.right_front.ang3);

  EXPECT_EQ(four_legs_desired_angs.left_front.ang1,
            test_legs_joint_angs.left_front.ang1);
  EXPECT_EQ(four_legs_desired_angs.left_front.ang2,
            test_legs_joint_angs.left_front.ang2);
  EXPECT_EQ(four_legs_desired_angs.left_front.ang3,
            test_legs_joint_angs.left_front.ang3);

  EXPECT_EQ(four_legs_desired_angs.left_back.ang1,
            test_legs_joint_angs.left_back.ang1);
  EXPECT_EQ(four_legs_desired_angs.left_back.ang2,
            test_legs_joint_angs.left_back.ang2);
  EXPECT_EQ(four_legs_desired_angs.left_back.ang3,
            test_legs_joint_angs.left_back.ang3);
}
...
TEST(testSetFootPos, basic_test) {
  ...
  float tol = 0.0001f;
  EXPECT_NEAR(four_legs_desired_pos.right_back.x,
              test_legs_foot_pos.right_back.x, tol);
  EXPECT_NEAR(four_legs_desired_pos.right_back.y,
              test_legs_foot_pos.right_back.y, tol);
  EXPECT_NEAR(four_legs_desired_pos.right_back.z,
              test_legs_foot_pos.right_back.z, tol);

  EXPECT_NEAR(four_legs_desired_pos.right_front.x,
              test_legs_foot_pos.right_front.x, tol);
  EXPECT_NEAR(four_legs_desired_pos.right_front.y,
              test_legs_foot_pos.right_front.y, tol);
  EXPECT_NEAR(four_legs_desired_pos.right_front.z,
              test_legs_foot_pos.right_front.z, tol);

  EXPECT_NEAR(four_legs_desired_pos.left_front.x,
              test_legs_foot_pos.left_front.x, tol);
  EXPECT_NEAR(four_legs_desired_pos.left_front.y,
              test_legs_foot_pos.left_front.y, tol);
  EXPECT_NEAR(four_legs_desired_pos.left_front.z,
              test_legs_foot_pos.left_front.z, tol);

  EXPECT_NEAR(four_legs_desired_pos.left_back.x, test_legs_foot_pos.left_back.x,
              tol);
  EXPECT_NEAR(four_legs_desired_pos.left_back.y, test_legs_foot_pos.left_back.y,
              tol);
  EXPECT_NEAR(four_legs_desired_pos.left_back.z, test_legs_foot_pos.left_back.z,
              tol);
}
...
TEST(testReturnBodyState, basic_test) {
  ...
  float truth_z = 0.13;
  float truth_phi = 0.1;
  float truth_theta = 0.05f;
  float truth_psi = -0.02f;
